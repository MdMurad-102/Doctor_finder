...
export default function AIChatScreen() {
    ...
    const generateAIResponse = async (userMessage: string) => {
        try {
            // Simple direct message format without system prompts (Gemma 3 12B limitation)
            const fullPrompt = `A patient says: "${userMessage}"

If this is a medical question, briefly analyze the symptoms in 1-2 sentences and recommend which type of specialist doctor they should consult (e.g., ${AI_CONFIG.SPECIALTIES.slice(0, 5).join(", ")}, etc.). 

If not medical-related, say "I can only help with medical questions. Please describe your health symptoms."

Keep response under 80 words. End with "Please consult a real doctor."`;
